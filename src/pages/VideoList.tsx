      ...
      <List
        ...
        renderItem={item => (
          <List.Item>
            ...
            >
              <Card.Meta 
                title={<div style={{ height: '48px', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>{item.title}</div>} 
                description={
                  <div>
                    <div style={{ marginBottom: '8px' }}>
                      <span style={{ color: 'rgba(0, 0, 0, 0.45)', marginRight: '8px' }}>{item.views}次观看</span>
